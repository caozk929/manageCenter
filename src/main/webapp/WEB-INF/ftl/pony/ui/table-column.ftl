...
表格列标签：展示数据列。
	...
	style：css样式style
-->
<#macro column title="" code="" width="" align="" class="" style="" name="">
...
<#else>
	<td<#if align!=""> align="${align}"</#if><#if name!=""> name="${name}"</#if><#if class!=""> class="${class}"</#if><#if style!=""> style="${style}"</#if>><#nested/></td><#rt/>
</#if>
</#macro>