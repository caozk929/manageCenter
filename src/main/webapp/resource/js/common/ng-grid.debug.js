...
var ngStyleProvider = function($scope, grid) {
    ...
    $scope.topPanelStyle = function() { 
        return { "width": "100%", "height": ($scope.topPanelHeight()+2) + "px" };
    };
    $scope.headerStyle = function() {
        return { "width":  "100%", "height": grid.config.headerRowHeight + "px" };
    };
    ...
    $scope.footerStyle = function() {
        return { "width": "100%", "height": $scope.footerRowHeight + "px" };
    };
};
...
angular.module('ngGrid').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('footerTemplate.html',
    ...
    "\n" +
    "            <button type=\"button\" class=\"ngPagerButton\" ng-click=\"pageBackward()\" ng-disabled=\"cantPageBackward()\" title=\"{{i18n.ngPagerPrevTitle}}\"><div class=\"ngPagerPrevTriangle ngPagerFirstTriangle\"></div></button>\r" +
    "\n" +
    "            <input class=\"ngPagerCurrent\" min=\"1\" max=\"{{currentMaxPages}}\" type=\"number\" style=\"width:50px; height: 20px; margin-top: 1px; padding: 0 4px;\" ng-model=\"pagingOptions.currentPage\"/>\r" +
    "\n" +
    "            <span class=\"ngGridMaxPagesNumber\" ng-show=\"maxPages() > 0\">/ {{maxPages()}}</span>\r" +
    "\n" +
    "            <button type=\"button\" class=\"ngPagerButton\" ng-click=\"pageForward()\" ng-disabled=\"cantPageForward()\" title=\"{{i18n.ngPagerNextTitle}}\"><div class=\"ngPagerNextTriangle ngPagerLastTriangle\"></div></button>\r" +
    "\n" +
