...
(function (window, angular, undefined) {
	...
	var module = angular.module('ngLoading', []);
	...
	module.provider('ngLoading', function () {
			...
			function ($document, $templateCache, $compile, $q, $http, $rootScope, $timeout, $window) {
				...
				var privateMethods = {
					...
					closeDialog: function ($dialog) {
						...
						$rootScope.$broadcast('ngLoading.closed', $dialog);
					}
				};
				...
				var publicMethods = {
					...
					open: function (opts) {
						...
						self.latestID = 'ngLoading' + globalID;
